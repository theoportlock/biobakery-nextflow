...
include { METAPHLAN; METAPHLAN_INIT; METAPHLAN_MERGE; METAPHLAN_TO_GTDB } from './modules/local/metaphlan/main.nf'
include { HUMANN; HUMANN_INIT; HUMANN_MERGE; HUMANN_RENORM; HUMANN_REGROUP } from './modules/local/humann/main.nf'
...
workflow {
    ...
    if (params.m) {
        ...
        //METAPHLAN_TO_GTDB(metaphlan_out.profile)
        //METAPHLAN_MERGE_GTDB(metaphlan_out.profile)
        metaphlan_merge = METAPHLAN_MERGE(metaphlan_out.profile.collect())
    }
